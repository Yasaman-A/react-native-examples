...
const Login = ({ navigation }) => {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <TextInput style={styles.input} value={password} secureTextEntry={true} label="Password" mode="outlined" placeholder="Enter your password" onChangeText={(text) => { setPassword(text); }} />
