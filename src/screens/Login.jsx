...
const Login = ({ navigation }) => {
  const [email, setEmail] = useState('newuser@new.user');
  const [password, setPassword] = useState('newnew');
  //= =========================================================================
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} value={password} secureTextEntry label="Password" mode="outlined" placeholder="Enter your password" onChangeText={(text) => { setPassword(text); }} />
