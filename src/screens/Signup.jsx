...
const Signup = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} label="Password" mode="outlined" placeholder="Enter your password" onChangeText={(text) => { setPassword(text); }} />
      <TextInput style={styles.input} label="Repeat Password" mode="outlined" placeholder="Confirm your password" onChangeText={(text) => { setRepeatPassword(text); }} />
